...
const FloatingWhatsAppButton = () => {
  ...
  const phoneNumber = '5492923530179';
  
  // Mensaje predeterminado
  const defaultMessage = '¡Hola! Me interesa conocer más sobre sus servicios financieros. ¿Podrían brindarme información?';
  ...
  return (
    <>
      ...
      {/* Opcional: Backdrop para cerrar en móviles */}
      {isHovered && (
        <div 
